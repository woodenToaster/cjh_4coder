...
cjh_mapid_c = managed_id_declare(app, string_u8_litexpr("command_map"), string_u8_litexpr("cjh_mapid_c"));
cjh_mapid_comma = managed_id_declare(app, string_u8_litexpr("command_map"), string_u8_litexpr("cjh_mapid_comma"));
cjh_mapid_d = managed_id_declare(app, string_u8_litexpr("command_map"), string_u8_litexpr("cjh_mapid_d"));
cjh_mapid_file = managed_id_declare(app, string_u8_litexpr("command_map"), string_u8_litexpr("cjh_mapid_file"));
cjh_mapid_g = managed_id_declare(app, string_u8_litexpr("command_map"), string_u8_litexpr("cjh_mapid_g"));
