...
set_default_color_scheme(Application_Links *app){
    ...
    default_color_table.arrays[defcolor_normal_cursor] = make_colors(arena, 0xFF00EE00);
    default_color_table.arrays[defcolor_insert_cursor] = make_colors(arena, 0xFF00EE00);
