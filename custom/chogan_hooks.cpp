/*
chogan_hooks.cpp - Sets up the hooks for the default framework.
*/
...
function void
chogan_render_buffer(Application_Links *app, View_ID view_id, Face_ID face_id,
...
cjh_render_caller(Application_Links *app, Frame_Info frame_info, View_ID view_id){
    ...
    chogan_render_buffer(app, view_id, face_id, buffer, text_layout_id, region);
